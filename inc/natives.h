...
namespace WEAPON
{
	...
	static BOOL GET_PED_LAST_WEAPON_IMPACT_COORD(Ped ped, float *coord) { return invoke<BOOL>(0x6C4D0409BA1A2BC2, ped, coord); } // 0x6C4D0409BA1A2BC2 0x9B266079
